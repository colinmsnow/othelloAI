...
def get_cart_location(screen_width):   #TODO: relace with board state?
...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        _, reward, done, _ = env.step(action.item())  #TODO: replace with make_move method
...
print('Complete')
env.render()  #TODO: Theseis does not exist so remove?
env.close()
plt.ioff()
plt.show()
