#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
# Simplified Othello Program
# Original by John Fish
# Updated from May 29, 2015 - June 26, 2015
#
# Has both basic AI (random decision) as well as
# educated AI (minimax).
#
# Modified by Megan Ku and Colin Snow
# Reducing graphics to increase speed for 
# RL AI.
#
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
class Board:
	...
	def slightlyLessDumbMove(self):
		...
		print(choices[bestIndex][0],choices[bestIndex][1])
...
def clickHandle(event):
    ...
    if running:
        ...
        if board.player==0:
            ...
            dumbChoice = choice(choices)
            print(dumbChoice)
            board.boardMove(dumbChoice[0],dumbChoice[1])
    else:
        depth = 6
        playGame()
